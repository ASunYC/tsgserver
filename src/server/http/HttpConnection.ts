...
import { ParsedServerInput } from "../../baseclient";
import { BaseServiceType } from "../../proto";
...
export class HttpConnection<ServiceType extends BaseServiceType = any> extends BaseConnection<ServiceType> {
    ...
    /**
     * Close the connection, the reason would be attached to response header `X-TSGServer-Close-Reason`.
     */
    close(reason?: string) {
        ...
        reason && this.httpRes.setHeader('X-TSGServer-Close-Reason', reason);
        this.httpRes.end();
    }
